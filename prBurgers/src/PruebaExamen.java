...
public class PruebaExamen {
	...
	public static void main(String[] args) {
		...
		p1.addAlimentos(burgers[0]);
		p1.addAlimentos(burgers[1]);
		p1.addAlimentos(helados[0]);
		p1.addAlimentos(helados[1]);
		p1.addAlimentos(patatas[0]);
		System.out.println(p1);
		
		// Crear otro pedido
		Pedido p2=new Pedido();
		p2.addAlimentos(burgers[2]);
		p2.addAlimentos(burgers[3]);
		p2.addAlimentos(burgers[4]);
		p2.addAlimentos(helados[2]);
		p2.addAlimentos(helados[3]);
		p2.addAlimentos(patatas[1]);
		p2.addAlimentos(patatas[2]);
		System.out.println(p1);
